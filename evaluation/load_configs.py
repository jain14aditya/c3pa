...
def load_from_pretrained():
    try: 
        ...
        print("Pre-trained model Path used : ", opts.model_name_or_path)
        print("Get tokenizer model from GPT2: ", opts.model_path)
...
# model, tokenizer, pretrain_stats, train_stats = None, None, None, None
model = None
tokenizer = None
pretrain_stats, train_stats = None, None
...
# print("Loading tokenizer from : ", opts.model_path)
# tokenizer = GPT2Tokenizer.from_pretrained(opts.model_path, 
#                                         pad_token='<|endoftext|>', cls_token='<|cls|>',
#                                         sep_token='<|sep|>')